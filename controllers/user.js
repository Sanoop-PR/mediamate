...
exports.hasNotications = async (req, res) => {
  try {
    ...
    const notificationsUser = await User.updateOne(
      { _id: user },
...
exports.profileBgImgChange = async (req, res) => {
  // console.log(req.body.link)
  try {
    const user = req.body.user;

    const updated = await User.updateOne({_id:user},{$set:{bgImage:req.body.link}})
