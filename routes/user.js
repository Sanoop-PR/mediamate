const { getUser, followHandle, getFollowings, getFollowers, notications, hasNotications, updateUser, search, getUserById, suggestions, changePassword, getAllUsers, resetPassword, checkResetToken, handleNewPassword ,profileBgImgChange } = require('../controllers/user')
...
router.route("/view/has-notifications/:notID").post(isAuthenticated, hasNotications)

router.route("/bgimgchange").put(isAuthenticated,profileBgImgChange)
